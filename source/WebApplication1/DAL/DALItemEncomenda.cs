...
namespace WebApplication1.DAL
{
    public class DALItemEncomenda : DAL
    {
        ...
        public static List<Modelo.itemEncomenda> SelectAll()
        {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public static Modelo.itemEncomenda Select(int idEncomenda, int idProduto, int idTamanho)
        {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public static List<Modelo.itemEncomenda> SelectFromEncomenda(int idEncomenda)
        {
            Modelo.itemEncomenda itemEncomenda;
            List<Modelo.itemEncomenda> itensEncomenda = new List<Modelo.itemEncomenda>();
        ...
        public static void Delete(Modelo.itemEncomenda itemEncomenda)
        {
            try
            {
                using (conn = new SqlConnection(connectionString))
        ...
        public static void Insert(Modelo.itemEncomenda itemEncomenda)
        {
            try
            {
                using (conn = new SqlConnection(connectionString))
        ...
        public static void Update(Modelo.itemEncomenda itemEncomenda)
        {
