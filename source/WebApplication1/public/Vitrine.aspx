    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <label class="checkbox-inline">
                    <input type="checkbox" name="marcadores" id="marcador<%= marcador.id %>" value="<%= marcador.id %>" <% if ((string[])Session["marcadores"] != null && ((string[])Session["marcadores"]).Contains(marcador.id.ToString())) { Response.Write("checked"); } %>>
                    <%= marcador.descricao %>
                </label>
                <% } %>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4" style="text-align: center; padding: 25px 0px 25px 0px;">
                <img class="card-img-top img-circle" src="/produtos/<% Response.Write(item.produto.imagem); %>" width="200px" style="margin: auto; margin-bottom: 20px;" />
